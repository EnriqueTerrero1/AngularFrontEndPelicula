...
export class DetallePeliculaComponent implements OnInit {
  ...
  constructor( private peliculaService:PeliculasService,
    private activatedRoute:ActivatedRoute,private sanitizar:DomSanitizer,private ratingService:RatingService) { }
  ...
  rated(puntuacion:number){
    ...
    .subscribe(()=>{Swal.fire("Exitoso","Su voto ha sido recibido",'success');})
  }
