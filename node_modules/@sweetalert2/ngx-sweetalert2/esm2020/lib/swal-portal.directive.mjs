...
SwalPortalDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.6", ngImport: i0, type: SwalPortalDirective, deps: [{ token: i0.ComponentFactoryResolver }, { token: i0.Injector }, { token: i0.ApplicationRef }, { token: i0.TemplateRef }, { token: i1.SweetAlert2LoaderService }, { token: i2.SwalPortalTargets }, { token: i3.SwalComponent, host: true }], target: i0.ɵɵFactoryTarget.Directive });
